...
(function(){
  ...
  function toggleAutoConnect() {
    ...
    // Auto-scan networks on page load (siempre, incluso si hay conexión)
    setTimeout(() => {
      scanNetworks();
    }, 2000);
    
    // Auto-scan networks every 60 seconds
    setInterval(() => {
      console.log('Actualizando redes WiFi (cada 60 segundos)...');
      scanNetworks();
    }, 60000);
