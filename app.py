...
def inject_get_locale():
    return dict(get_locale=get_locale, csrf_token=csrf._get_token)
...
def wifi_connect():
    try:
        ...
        app.logger.debug(f'Resultado nmcli - Código: {result.returncode}, Salida: {result.stdout}, Error: {result.stderr}')
