...
from core.i18n import get_html_translations, get_language_list
...
async def get_translations(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error getting translations")
...
async def get_available_languages(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error getting available languages") 